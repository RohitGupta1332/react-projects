              ...
              <form action="#!">
                <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                  <div className="col-12">
                    ...
                    <input type="text" className="form-control" id="fullname" name="fullname" value={fullname} onChange={(e) => {setName(e.target.value)}} required/>
                  </div>
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    <div className="input-group">
                      ...
                      <input type="tel" className="form-control" id="phone" name="phone"  value={number} onChange={(e) => {setNumber(e.target.value)}} />
                    </div>
                  </div>
                  <div className="col-12">
                    <label htmlFor="subject" className="form-label">Subject <span className="text-danger">*</span></label>
                    <input type="text" className="form-control" id="subject" name="subject" value={subject} onChange={(e) => {setSubject(e.target.value)}}  required/>
                  </div>
                  <div className="col-12">
